<!-- synchronized report: sign-15/constant_time.md -->
# Constant-time review — 15 MORNING-ATLAS

Scope: reference implementation, representative instance only: `Implementation/Reference_Implementation/lwrdsa192/SIG_lwrdsa192.c`. Other instances and optimized implementations have not been proven source-equivalent. This is a source-level triage, not a constant-time certification.
...
- Branch/loop trace: `Implementation/Reference_Implementation/lwrdsa192/SIG_lwrdsa192.c:365` — The signer retries when `polyvecl_chknorm(&z, …)` rejects a secret-key-dependent response.
