<!-- synchronized report: sign-14/constant_time.md -->
# Constant-time review — 14 Lynxer

Scope: reference implementation, representative instance only: `Implementations/Reference_Implementation/Lynxer-512f/SIG_AlgorithmInstance.c`. Other instances and optimized implementations have not been proven source-equivalent. This is a source-level triage, not a constant-time certification.
...
- Branch/loop trace: `Implementations/Reference_Implementation/Lynxer-512f/SIG_AlgorithmInstance.c:71` — The wrapper validates a public secret-key length; this is not secret-value leakage. The hidden witness is processed in deeper source files.
