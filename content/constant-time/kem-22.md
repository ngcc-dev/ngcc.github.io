<!-- synchronized report: kem-22/constant_time.md -->
# Constant-time review — kem-22 Mithril

Scope: representative reference instance `Implementations/Reference_Implementation/Mithril-128/kem.c`; other levels, optimized copies and compiled machine code are not certified by this source review.
...
- Source trace: `Implementations/Reference_Implementation/Mithril-128/kem.c:150` — The ciphertext comparison feeds a mask-based shared-secret selection at lines 150–153. The length branch at line 127 is public.
