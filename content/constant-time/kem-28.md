<!-- synchronized report: kem-28/constant_time.md -->
# Constant-time review — kem-28 OAEP-NTRU

Scope: representative reference instance `Implementations/Reference_Implementation/OAEP-NTRU-648/KEM_AlgorithmInstance.c`; other levels, optimized copies and compiled machine code are not certified by this source review.
...
- Source trace: `Implementations/Reference_Implementation/OAEP-NTRU-648/KEM_AlgorithmInstance.c:190` — The decapsulation accumulator incorporates private decryption/check results and is returned as `fail` at line 209; the API already exposes this validity result.
